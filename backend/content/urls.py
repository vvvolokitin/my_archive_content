...
from content.views import (
    ...
    MovieDetailView,
    MovieListView,
    MovieStatusUpdateView,
    MovieUpdateView,
    SerialCreateView,
    SerialDeleteView,
    SerialDetailView,
    SerialListView,
    SerialStatusUpdateView,
    SerialUpdateView
)
...
urlpatterns = [
    ...
    path('movie/edit_status/<int:pk>/',
         MovieStatusUpdateView.as_view(), name='movie_edit_status'),
    ...
    path('serial/edit_status/<int:pk>/',
         SerialStatusUpdateView.as_view(), name='serial_edit_status'),
    ...
    path('game/edit_status/<int:pk>/',
         GameStatusUpdateView.as_view(), name='game_edit_status'),
    ...
    path('book/edit_status/<int:pk>/',
         BookStatusUpdateView.as_view(), name='book_edit_status'),
